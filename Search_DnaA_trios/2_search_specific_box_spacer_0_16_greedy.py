...
def which_box(NC):
    with open(r'Species_specific_DnaA_Box_motif.csv', 'r') as f1:
...
def all_steps(seq, start, end, NC, motif, maxPosition, mis_max, max_gc_len, ORI):  # 输入的seq是字符串格式
    result = pd.DataFrame()
...
if __name__ == '__main__':
    ...
    with open(file_doric, 'r') as f_doric:
        ...
        result.to_csv(
            '2_search_specific_box_spacer_0_16_greedy.csv', index=False)
